    ...
    function e() {
        ...
        if (!t.isRender) {
            ...
            function GetPosition() {                  
                    ...
                    var advet = '<mip-ad layout="reponsive" width="' + adWidth + '" height="' + adHeight + '"  type="ad-comm"tpl="oneImg" 
                    class="' + adClass + '" href="' + adHref + '" data-size="1242 180" src="' + adSrc + '" data-title="' + adTitle + '">
                        </mip-ad>';
                    if (arry_length2 == 0) {
                        $(rank).append(advet);
                    } else {
