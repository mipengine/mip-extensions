define('mip-ttjj-fund-detail', ['require', 'customElement', 'zepto'], function (require) {
    ...
    customElem.prototype.build = function () {
        ...
        param.data.FCODE = funCaller.getQueryString('fundcode');
        param.dataPage.FCODE = funCaller.getQueryString('fundcode');
        funCaller.init();
    };
    var param = {
            data: {
...
require(['mip-ttjj-fund-detail'], function (plugindemo) {
    var css = __inline('./mip-ttjj-fund-detail.less');
    MIP.css.mipttjjfunddetail = css;
    MIP.registerMipElement('mip-ttjj-fund-detail', plugindemo,MIP.css.mipttjjfunddetail);
});