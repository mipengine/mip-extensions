define(function(require) {
    ...
    var zhezhao = "<div class='mip-gzpd-alert-marks'>" +
        ...
        "    <div class='paybox-img'><a href='"+ payUrl +"'><img src='//static.yjbys.com/qrcode/pay.jpg'></a></div>" +
        "    <div class='paybox-money'><h2>"+alt.alert.detail[0]+"</h2><span>"+alt.alert.detail[1]+"</span></div>" +
        "    <a class='paybox-bottom-a' href='"+ payUrl +"'><div class='paybox-bottom'>"+alt.alert.btn+"</div></a>" +
    ...
    var payAlert = '<div class="mip-gzpd-alert-marks-wxpay">' +
        ...
        '        <div class="payqr_box">' +
        '            <div class="hc" style="display: block;"><img src="https://static.yjbys.com/img/my/company/wxzhifu_load.gif"></div>' +
        '            <div class="zhifu">' +
        '                <div class="sm">'+alt.alertWx.detail[0]+'<span>'+alt.alertWx.detail[1]+'</span></div>' +
        '            </div>' +
        '        </div>' +
