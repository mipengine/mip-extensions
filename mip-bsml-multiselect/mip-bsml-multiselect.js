        ...
        (function ($) {
            ...
            MultipleSelect.prototype = {
                ...
                optionToHtml: function (i, elm, group, groupDisabled) {
                    ...
                    var title = sprintf('title="%s"', $elm.attr('title'));
                    ...
                    if ($elm.is('option')) {
                        var value = $elm.val();
                        var text = that.options.textTemplate($elm);
                        var selected = $elm.prop('selected');
                        var style = sprintf('style="%s"', this.options.styler(value));
                        var $el;
                ...
                events: function () {
                    ...
                    this.$selectGroups.off('click').on('click', function () {
                        ...
                        var $items = that.$selectItems.filter(':visible');
                        var $children = $items.filter(sprintf('[data-group="%s"]', group));
                ...
                setSelects: function (values) {
                    ...
                    $.each(that.$selectGroups, function (i, val) {
                        var group = $(val).parent().attr('data-group');
                        var $children = that.$selectItems.filter('[data-group="' + group + '"]');
                        $(val).prop('checked', $children.length
                            && $children.length === $children.filter(':checked').length);
                    });
