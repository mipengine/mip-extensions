...
define(function (require) {
    ...
    var putTestHtml = function () {
        ...
        html += 'data-stats-baidu-obj=\'%22%7B%22type%22:%22click%22,%22data%22:%22%5B';
        html += '_trackEvent\',%20\'100m\',%20\'0\',%20\'8001m\'%5D%22%7D%22\'>';
    ...
    var putTestButHtml = function () {
        ...
        htmls += '<div class=\'put-test-hh\' pos=\'2\'';
        htmls += 'data-stats-baidu-obj=\'%22%7B%22type%22:%22click%22,%22data%22:%22%5B\'_trackEvent\',';
        htmls += '%20\'100m\',%20\'0\',%20\'8002m\'%5D%22%7D%22\'>';
        htmls += '<mip-img class=\'mip-img\' src=\'http://pic.iask.cn/fimg/8560954695_1200.jpg\'></mip-img>';
        htmls += '</div>';
    ...
    var effects = {
            ...
            commercialLoad: function () {
                if (validatePut()) {
                    ...
                    if (startTime <= nowTime && nowTime < endTime) {
                        var putUrl = '//h.chanjet.com/others/sina/a.html';
                        var rdmMidToday = (Math.random() * 100) + 1;
                        var $baidu = $('.mip_stats_baidu_js');
                        if (rdmMidToday > 50) {
                            putUrl = '//h.chanjet.com/others/sina/b.html';
                            var divStr = '<mip-stats-baidu token=\'03a10494c7c68a436a6b8914e29c8e59\'>';
                            divStr += '</mip-stats-baidu>';
                            $baidu.append(divStr);
                            var divStr1 = '<div data-stats-baidu-obj=\'%22%7B%22type%22:%22load%22';
                            divStr1 += ',%22data%22:%22%5B\'_trackEvent\'';
                            divStr1 += ',%20\'100m\',%20\'0\',%20\'8002m\'%5D%22%7D%22\'></div>';
                            $baidu.append(divStr1);
                        }
                        else {
                            var divStr1 = '<mip-stats-baidu token=\'4d053a0029fb3cca4c9d702fea8ac599\'>';
                            divStr1 += '</mip-stats-baidu>';
                            $baidu.append(divStr1);
                            var divStr = '<div data-stats-baidu-obj=\'%22%7B%22type%22:%22load%22,%22data%22:%22%5B\'';
                            divStr += '_trackEvent\',%20\'100m\',%20\'0\',%20\'8001m\'%5D%22%7D%22\'></div>';
                            $baidu.append(divStr);
                        }
                        removeBaiduAd();
