...
mip-jituan-form 表单组件

标题|内容
----|----
类型|通用
支持布局|fixed
所需脚本|https://c.mipcdn.com/static/v1/mip-jituan-form/mip-jituan-form.js

## 示例
### 基本使用

```html
<mip-jituan-form method="get" fetch-url="http://m.v2.258.com/testapi">
...
```html
<mip-jituan-form method="get" url="https://www.mipengine.org" clear>
...
```html
<mip-jituan-form method="get" url="https://www.mipengine.org">
...
```html
<mip-jituan-form fetch-url="http://yourdomain.com/path">
